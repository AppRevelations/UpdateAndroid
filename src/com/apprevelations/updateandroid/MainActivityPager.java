...
public class MainActivityPager extends FragmentActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (flag == 1) {
			Intent imain = new Intent(MainActivityPager.this,
					com.apprevelations.updateandroid.MainActivity.class);
			startActivity(imain);
			this.finish();
		} else {
				...
				if (position == 2) {
					...
					gpp.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							Intent igapp = new Intent(
									MainActivityPager.this,
									com.apprevelations.updateandroid.MainActivity.class);
							startActivity(igapp);
							finish();
